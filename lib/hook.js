...
var path = require('path'),
    ...
    vm = require('vm'),
    originalJsLoader = Module._extensions['.js'],
    originalCoffeeLoader = Module._extensions['.coffee'],
...
function transformFn(matcher, transformer, verbose) {
    ...
    return function (code, filename) {
        if (verbose) { console.error('shouldHook: ' + filename + ' ' + matcher(path.resolve(filename))); }
...
function hookRequire(matcher, transformer, options) {
    ...
    hookFunction = function (originalHook) {
    ...
    Module._extensions['.js'] = hookFunction(originalJsLoader);
    Module._extensions['.coffee'] = hookFunction(originalCoffeeLoader);
}
/**
...
function unhookRequire() {
    ...
    Module._extensions['.coffee'] = originalCoffeeLoader;
}
/**
